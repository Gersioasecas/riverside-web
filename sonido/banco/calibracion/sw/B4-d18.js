...
function construirMar(ctx, dur) {
  ...
  const BARRAS    = 4;      // líneas de rotura que cruza cada ola
  const DBARRA    = 1.8;    // s entre una barra y la siguiente
  const CAIDA     = 0.72;   // cuánto se debilita la rotura en cada barra
  const VIENTO_dB = 1.5;
