  ...
  for (let v = 0; v < VOCES; v++) {
    ...
    while (t < dur) {
      ...
      if (u >= 0.45) {                                  // ~20 % no rompen
        const g = Math.min(1.6, Math.pow(u, 1.29)) * 0.30;
